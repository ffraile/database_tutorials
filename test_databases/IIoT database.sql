...
INSERT INTO device_types (device_type_id, device_name, device_description) VALUES (1, "BOSCH XDK 110", "Wireless sensor for rapid prototyping, it allows users an easy transition from prototype to mass production
by providing a clear road to product development.");
